...
function createPanZoom(domElement, options) {
  ...
  /* Modification: Make sure changes on image are reset on prev/next */
  ...
  function dispose() {
    ...
    // owner.removeEventListener('dblclick', onDoubleClick)            UNCOMMENT TO ENABLE DOUBLE CLICK
    if (frameAnimation) {
  ...
  function listenForEvents() {
    ...
    //owner.addEventListener('dblclick', onDoubleClick)      UNCOMMENT TO ENABLE DOUBLE CLICK
  ...
  function onKeyDown(e) {
    var x = 0, y = 0, z = 0, rotation = domElement.parentElement.style.transform
    /***********************************************************************/
    /* Modification to ensure correct direction for arrow keys on rotation */
    /***********************************************************************/
  ...
  function onMouseMove(e) {
    ...
    /* Make sure that pan is in the right direction upon rotation */
    var rotation = domElement.parentElement.style.transform;

    if(rotation === "rotate(270deg)")
      internalMoveBy(-dy,dx)
    else if(rotation === "rotate(180deg)")
      internalMoveBy(-dx, -dy)
    else if(rotation === "rotate(90deg)")
      internalMoveBy(dy,-dx)
